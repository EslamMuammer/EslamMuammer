...
Physics & Laser Science background, now applied to data analysis. I work across the analytics lifecycle — using SQL and Python for exploration, and Power BI and Tableau for dashboards — turning raw datasets into KPIs and recommendations that support business decisions.
